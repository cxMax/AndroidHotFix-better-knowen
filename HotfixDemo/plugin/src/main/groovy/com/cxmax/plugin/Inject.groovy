...
/**
 * 入代码分为两种情况，一种是目录，需要遍历里面的class进行注入
...
public class Inject {
        ...
        if (dir.isDirectory()) {
            dir.eachFileRecurse { File file ->
                ...
                if (filePath.endsWith(".class")
                    ...
                    int index = filePath.indexOf("com\\cxmax\\hotfixdemo")
                    if (index != -1) {
    ...
    private static void injectClass(String className, String path) {
        ...
        constructor.insertAfter("System.out.println(com.cxmax.inject.AntilazyLoad.class);")
        c.writeFile(path)
    }
}